// Spool icon matching Mainsail/Spoolman's design:
// outer ring = filament color, gray middle ring, dark gray spool detail
export function SpoolIcon({
  ...
  return (
    ...
    >
      {/* Outer ring — filament color */}
      <circle cx="243.52" cy="243.52" r="232.97" fill={color} />
      {/* Middle ring — neutral gray */}
      <circle cx="243.52" cy="243.52" r="112.5" fill={middleColor} />
      {/* Spool detail path — dark gray, matches Mainsail exactly */}
      <path
        fill={hubColor}
